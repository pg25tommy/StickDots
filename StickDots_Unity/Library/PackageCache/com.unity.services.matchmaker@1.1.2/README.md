# How to install Matchmaker into your Unity project
...
`com.unity.services.matchmaker` and select package.json > open
...
async void MakeAPICall()
{
    ...
    var response = await MatchmakerApiService.FakeClient.FakeApiGetAsync(r);
}
```
